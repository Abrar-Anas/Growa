...
//                     _TextFieldEditor(
//                       label: "Product ID",
//                       controllerType: _productIDController,
...
//                       controllerType: _confirmPasswordController,
...
//                       label: "Address",
//                       controllerType: _addressController,
//                       prefixIcon: Image.asset('assets/icons/lock-icon.png'),
//                     ),
...
//         hint: Text("Enter Product ID", style: TextStyle(color: tfcolor)),
//         filled: true,
//         fillColor: tint,
...
//     obscureText: false,
//     decoration: InputDecoration(
//       hint: Text(hint, style: TextStyle(color: tfcolor)),
